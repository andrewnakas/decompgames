...
| `allowed_cursor_rail_types.cpp` | Buildable board cells | Independent candidate board generated; compile/gameplay pending. |
| `entrance_rails.cpp` | Eligible entrance positions | Independent candidate left/right entrance banks generated; compile, placement, and routing pending. |
| `train_specification.cpp` | Train availability, speed, and composition | Independent candidate roster generated; compile and gameplay balance pending. |
| `chunk_bounding_boxes.cpp` | Incremental redraw regions | Candidate bounds enlarged for new rail sprites; compile and ghosting checks pending. |
