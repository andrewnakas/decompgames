...
| Digger Remastered | https://github.com/sobomax/digger and https://www.digger.org/faq.html document remaster/source rights; its upstream WASM target builds at the pinned revision | Eight generated CC0 layouts compile into the engine. Still blocked because the binary embeds upstream graphics, title and icon data; see `docs/digger-replacement-integration.md`. |
