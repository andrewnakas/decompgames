...
| ShortLine / reSL | https://github.com/konovalov-aleks/reSL documents a GPL-3.0 reverse-engineered game and upstream Emscripten target | Active addition 3 candidate. The pinned code builds privately, and an independent CC0 external-screen/icon generator exists. Upstream original resources and embedded reconstructed visual tables are excluded from release; the glyph audit and replacement build remain. |
